...
def logger_txt(log_file,epoch,scores):
    ...
    mae, mse, nae, mae_10, nae_10, loss = scores
    ...
    with open(log_file, 'a') as f:
        ...
        f.write('    [mae %.2f mse %.2f nae %.4f mae_10 %.2f nae_10 %.4f], [val loss %.4f]\n' % (mae, mse, nae, mae_10, nae_10, loss))
        f.write('='*15 + '+'*15 + '='*15 + '\n\n')    
...
def print_NWPU_summary(exp_name,log_txt,epoch, scores,train_record,c_maes,c_mses,c_naes):
    ...
    with open(log_txt, 'a') as f:
        ...
        f.write('  [mae %.2f mse %.2f nae %.4f mae_10 %.2f nae_10 %.4f], [val loss %.6f]\n\n' % (mae, mse, nae, mae_10, nae_10, loss))
    ...
    print( exp_name )
    print( '    '+ '-'*20 )
    print( 'val [mae %.2f mse %.2f nae %.4f], [val loss %.6f]' % (mae, mse, nae, loss) )
    print( '    '+ '-'*20 )
